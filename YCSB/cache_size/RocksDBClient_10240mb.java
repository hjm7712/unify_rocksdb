...
public class RocksDBClient extends DB {
  ...
  private RocksDB initRocksDB(final int threadcount) throws IOException, RocksDBException {
    ...
    blockBasedTableConfig.setMetadataBlockSize(4096);
    ...
    long blockCacheSize = 10 * 1024 * 1024 * 1024;
    Cache customCache = new LRUCache(blockCacheSize, 6, true, 0.0);
    blockBasedTableConfig.setBlockCache(customCache);

    for(final String cfName : cfNames) {
//      CompactionOptionsFIFO cpoptions = new CompactionOptionsFIFO()
//          .setAllowCompaction(true)
//          .setMaxTableFilesSize(0);
      final ColumnFamilyOptions cfOptions = new ColumnFamilyOptions()
          .setCompressionType(CompressionType.NO_COMPRESSION)
          .setTableFormatConfig(blockBasedTableConfig);
          //.setCompactionOptionsFIFO(cpoptions)
