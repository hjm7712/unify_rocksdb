...
#include <atomic>
extern unsigned long long total_latency, found_get[64];
...
//  printf("total_get %llu total_latency %f total_get %llu avg_latency %f\n",
//		  total_get.load(), (double)total_latency/2600, found_get[0], ((double)total_latency/2600)/found_get[0]);
